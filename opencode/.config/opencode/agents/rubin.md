...
Execute the exact task given to you (product MVP, music track, blog, newsletter). Use flow and minimalism. Output:
1. Creative approach.
2. Ready-to-use content, code, or asset.
3. Next milestone progress.
4. A short summary of what to do next.

Create with discipline and inspiration. Focus on shipping.